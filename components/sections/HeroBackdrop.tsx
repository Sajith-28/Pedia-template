import { PediatricDoodlesBackdrop } from "@/components/ui/PediatricDecorations";

/**
 * Hero atmosphere: slow-drifting colour washes and cute pediatric decorative doodles.
 */
export function HeroBackdrop() {
  return (
    <div aria-hidden="true" className="pointer-events-none absolute inset-0 overflow-hidden">
      {/* Soft pediatric pastel washes */}
      ...
      {/* Cute Floating Pediatric SVGs */}
      <PediatricDoodlesBackdrop density="full" />
